...
namespace EmotionalFix
{
	public static class Helper
	{
        ...
        public static LorId GetLorId(int id)
        {
            return new LorId(packageId,id);
        }
        public static T FindBuf<T>(BattleUnitModel model, BufReadyType bufReadyType = BufReadyType.ThisRound) where T : BattleUnitBuf
        {
            if (model == null)
                return null;

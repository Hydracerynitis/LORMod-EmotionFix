    ...
    public class EmotionCardAbility_keter_bloodbath1 : EmotionCardAbilityBase
    {
        ...
        public override void OnStartBattle()
        {
            ...
            if (DefenseDice.Count > 0)
                _owner.cardSlotDetail.keepCard.AddBehaviours(BattleDiceCardModel.CreatePlayingCard(ItemXmlDataList.instance.GetCardItem(Helper.GetLorId(1110001))), DefenseDice);
        }

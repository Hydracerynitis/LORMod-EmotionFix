...
namespace EmotionalFix.Keter
{
    public class EmotionCardAbility_keter_snowqueen2 : EmotionCardAbilityBase
    {
        ...
        public override void OnWinParrying(BattleDiceBehavior behavior)
        {
            ...
            if (cnt != 2)
                return;
            EmotionCardAbility_snowqueen2.BattleUnitBuf_Emotion_SnowQueen_Shard buf = Helper.FindBuf<EmotionCardAbility_snowqueen2.BattleUnitBuf_Emotion_SnowQueen_Shard>(target);
            if (buf == null)
            {

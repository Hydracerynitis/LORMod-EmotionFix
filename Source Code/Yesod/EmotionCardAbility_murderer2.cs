        ...
        public override void OnSucceedAttack(BattleDiceBehavior behavior)
        {
            ...
            if (this._owner.faction == Faction.Player)
            {
                if (behavior.Detail != BehaviourDetail.Hit)
                    return;
                BattleUnitBuf Debuff = target.bufListDetail.GetActivatedBufList().Find((Predicate<BattleUnitBuf>)(x => x is HitDebuff));
                if (Debuff == null)
            ...
            {
                BattleUnitBuf Debuff = target.bufListDetail.GetActivatedBufList().Find((Predicate<BattleUnitBuf>)(x => x is HitDebuffEnemy));
                if (Debuff == null)

...
{
    public class BehaviourAction_BossBird6SoundNear : BehaviourActionBase
    {
        ...
        {
            SingletonBehavior<SoundEffectManager>.Instance.PlayClip("Creature/Bossbird_Longbird_StongAtk", false,1f);
